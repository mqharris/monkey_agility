...
# read all the files, make predictions, then save
counter = 1
...
for filename in sorted(os.listdir(directory)):
    ...
    # plt.show()
    plt.savefig(output_dir + "/output_{}".format(counter))
    plt.close()
...
print("processed {} frames in {} seconds, giving {} fps".format(counter, time_taken, counter/time_taken))
